...
public class Panel extends JPanel {
    ...
    private void createButtons() {
        ...
        buttonMap.put(new ButtonBlueprint(10, 10, 200, 50, actionHandler), event -> buttonEvents.outPrintText(1));
        buttonMap.put(new ButtonBlueprint(10, 60, 200, 50, actionHandler), event -> buttonEvents.outPrintText(2));
        buttonMap.put(new ButtonBlueprint(10, 110, 200, 50, actionHandler), event -> buttonEvents.outPrintText(3));
